...
const CreatePasswordForm = () => {
  ...
  return (
    <div className='w-full'>
      ...
      <div className='2xl:mt-8 mt-6 text-center 2xl:text-3xl lg:text-2xl text-xl font-bold text-default-900'>
        Create New Password
      </div>
      <div className='2xl:text-lg text-center text-base text-default-600 mt-2 leading-6'>
