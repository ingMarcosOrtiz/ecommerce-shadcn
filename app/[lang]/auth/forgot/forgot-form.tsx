...
const ForgotForm = () => {
  ...
  return (
    <div className='w-full'>
      ...
      <div className='2xl:mt-8 mt-6 2xl:text-3xl text-center text-2xl font-bold text-default-900'>
        ¿Olvidaste tu contraseña?
      </div>
      <div className='2xl:text-lg text-base text-default-600 text-center mt-2 leading-6'>
